...
<script src="../js/userEditName.js" type="text/javascript" language="javascript"></script>
<!-- InstanceEndEditable -->
...
<table class="tableFormRegister" align="center">
	<tr><td><h2>USER PROFILE - EDIT NAME</h2></td></tr>
</table>

<!--EDIT NAME FORM-->

<form id="EditName" name="formEditName" method="post" action="../php/nameChanged.php"  onsubmit="return validateForm()">
<table class="formData" align="center">
	<tr>
    	<td colspan="2">&nbsp;</td>
    </tr>
	<tr>
        <td width="282" class="formLabel">First Name</td>
        <td width="366"><input type="text" id="FName" name="txtFName" size="30" /></td>
    </tr>
    <tr>
    	<td class="formLabel">Last Name</td><td><input type="text" id="LName" name="txtLName" size="30" /></td>
    </tr>
    <tr>
   	 <td colspan="2"><hr /></td>
    </tr>
